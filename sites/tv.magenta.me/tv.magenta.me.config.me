...
module.exports = {
  ...
  url: function ({ channel, date }) {
    return `${API_ENDPOINT}/epg/channel/schedules/v2?date=${date.format('YYYY-MM-DD')}&hour_offset=${date.format('H')}&hour_range=3&filler=true&station_ids=${channel.site_id}&app_language=me&natco_code=me`
  },
